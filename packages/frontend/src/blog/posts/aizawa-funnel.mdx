...
Defaults on Classical Chaos (close to the [archive workshop](https://github.com/kgz/CanvasWorld_archive/tree/master/(3d)%20Aizawa%20Attractor)): `a=0.95`, `b=0.7`, `c=0.6`, `d=3.5`, `e=0.25`, `f=0.1`, `dt=0.01`, seed `(0.1, 0, 0)`. A second preset keeps the archive’s longer decimals.
