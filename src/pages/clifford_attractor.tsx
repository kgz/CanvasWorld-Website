        ...
        setBodyJSX(
            <>
                <DatGui data={datData} onUpdate={(data: DatData) => {
                    ...
                    <DatNumber path="a" min={-3} max={3} step={0.01} />
                    <DatNumber path="b" min={-3} max={3} step={0.01} />
                    <DatNumber path="c" min={-3} max={3} step={0.01} />
                    <DatNumber path="d" min={-3} max={3} step={0.01} />
