...
import type { TDatData, TDataFromObject, TPointsProps, TsetBodyJSX } from './_base'
import Base, { EDimensions } from './_base'
import { InlineMath, BlockMath } from 'react-katex'
import { BaseRoute, addRoute } from '../@types/routes'

const HopalongAttractor = ({ setBodyJSX }: { setBodyJSX: TsetBodyJSX }) => {
	const datData = {
		options: {
			a: {
				initialValue: 1.4,
	...
	return (
		<Base<TData>
			...
			datData={datData as unknown as TDatData}
