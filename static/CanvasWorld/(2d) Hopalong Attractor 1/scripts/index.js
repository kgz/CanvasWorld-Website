...
class options {
    constructor() {
        this.a = 2.3844206291402226 * scale;
        this.b = 5.2* scale; 
        this.c = 4.8 * scale;
...
$(function () {
    ...
    let up = function () {
        ...
        for (let index = 0; index < numParticles; index++) {
            ...
            let x1 = y - 1 - Math.sign(Math.abs(b*x - 1 - c)) - Math.sign(x-1);
            let y1 = a-x-1;
            ...
            positions[currentPos++] = x * 2; //- $("#canvas").innerWidth()/2;
            positions[currentPos++] = y * 2;
