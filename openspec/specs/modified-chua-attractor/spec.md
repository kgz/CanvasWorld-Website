# modified-chua-attractor Specification

## Purpose
TBD - created by archiving change modified-chua-attractor. Update Purpose after archive.
## Requirements
...
- **THEN** `modified_chua_attractor` is active with title, description, and thumbnail
...
- **THEN** the Modified Chua notebook appears in `blog-posts.json` with a viz embed slug
