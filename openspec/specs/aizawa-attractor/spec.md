# aizawa-attractor Specification

## Purpose
TBD - created by archiving change aizawa-attractor. Update Purpose after archive.
## Requirements
...
- **THEN** `aizawa_attractor` is active with title, description, and thumbnail
...
- **THEN** the Aizawa notebook appears in `blog-posts.json` with a viz embed slug
