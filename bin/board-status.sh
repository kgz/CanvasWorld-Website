#!/usr/bin/env bash
# Update GitHub Project #6 (CanvasWorld) card status for issues.
...
PROJECT_ID="PVT_kwHOAI9yDM4BgbHR"
FIELD_ID="PVTSSF_lAHOAI9yDM4BgbHRzhcdAm0"
PROJECT_NUMBER=6
REPO_OWNER="kgz"
REPO_NAME="CanvasWorld-Website"
TMPDIR="${TMPDIR:-/tmp}/cw-board-$$"
mkdir -p "$TMPDIR"
